...
public class Common {
	...
	public static final String CODE_ERROR_DB = "100";
	public static final String CODE_ERROR_FULL = "101";
	public static final String CODE_ERROR_CONNECTION_ROOM = "102";
	public static final String CODE_ERROR_DECRYPTION = "103";
	public static final String CODE_ERROR_EMAIL_OVERLAP = "200";
	public static final String CODE_ERROR_EMAIL_NOT_FOUND = "201";
	public static final String CODE_ERROR_PASSWORD_MISS = "202";
	public static final String CODE_ERROR_PASSWORD_FAIL_FULL = "203";
	public static final String CODE_ERROR_NICKNAME_OVERLAP = "204";
}
